// @ts-types="npm:@types/ioredis"
import Redis from 'npm:ioredis';
import { Worker, Job } from 'npm:bullmq';
...
function sendStatusToWebhook(job: Job, status: string, fps: number|null = null, bitrate: number|null = null){
